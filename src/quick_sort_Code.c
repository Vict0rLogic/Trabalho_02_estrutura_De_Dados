...
static int particionar(int lista[], int inicio, int fim, long long* comparacoes, long long* trocas) {
    int pivo = lista[fim];
    int i = (inicio - 1);
...
static void quick_sort_recursivo(int lista[], int inicio, int fim, long long* comparacoes, long long* trocas) {
    if (inicio < fim) {
        int pi = particionar(lista, inicio, fim, comparacoes, trocas);
        quick_sort_recursivo(lista, inicio, pi - 1, comparacoes, trocas);
        quick_sort_recursivo(lista, pi + 1, fim, comparacoes, trocas);
    }
}

void quick_sort(int lista[], int n, long long* comparacoes, long long* trocas) {
    *comparacoes = 0;
    *trocas = 0;
    quick_sort_recursivo(lista, 0, n - 1, comparacoes, trocas);
}
...
void executar_mini_experimento(int n_exp) {
    ...
    quick_sort(lista, n_exp, &comps, &trocs);
